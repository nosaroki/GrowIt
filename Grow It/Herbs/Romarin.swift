            ...
            ScrollView {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        Spacer()
                        Group{
                            Image(romarin.water.0)
                            Image(romarin.water.1)
                            Image(romarin.water.1)
                        }
                        Spacer()
                        Group {
                            Image(romarin.tools.0)
                            Image(romarin.tools.1)
                            Image(romarin.tools.1)
                        }
                        Spacer()
                    }
...
struct Romarin_Previews: PreviewProvider {
