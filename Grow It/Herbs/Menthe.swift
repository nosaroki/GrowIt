            ...
            ScrollView {
                ...
                VStack {
                    ...
                    HStack {
                        ...
                        Spacer()
                        Group{
                            Image(menthe.water.0)
                            Image(menthe.water.0)
                            Image(menthe.water.1)
                        }
                        Spacer()
                        Group {
                            Image(menthe.tools.0)
                            Image(menthe.tools.1)
                            Image(menthe.tools.1)
                        }
                        Spacer()
                    }
...
struct Menthe_Previews: PreviewProvider {
