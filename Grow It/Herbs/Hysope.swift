            ...
            ScrollView {
                ...
                VStack{
                    ...
                    HStack {
                        ...
                        Spacer()
                        Group{
                            Image(hysope.water.0)
                            Image(hysope.water.1)
                            Image(hysope.water.1)
                        }
                        Spacer()
                        Group {
                            Image(hysope.tools.0)
                            Image(hysope.tools.1)
                            Image(hysope.tools.1)
                        }
                        Spacer()
                    }
...
struct Hysope_Previews: PreviewProvider {
